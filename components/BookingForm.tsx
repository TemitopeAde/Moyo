                        ...
                        <form onSubmit={handleSubmit} className="space-y-9 md:space-y-12">
                            <div className="grid gap-8 md:grid-cols-2 md:gap-12">
                                <div className="space-y-3 group">
                                    ...
                                    <input
                                        ...
                                        className="field-frost w-full rounded-md px-4 py-3 text-foreground outline-none transition-colors font-body"
                                    />
                                </div>
                                <div className="space-y-3 group">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {services.map((service) => (
                                        <button
                                            ...
                                            className={`field-frost px-4 py-2 text-[10px] uppercase tracking-widest transition-all duration-500 rounded-full sm:px-6 ${formData.service === service.id
                                                ? 'text-accent'
                            ...
                            <div className="space-y-3 group pt-4">
                                ...
                                <textarea
                                    ...
                                    className="field-frost w-full rounded-md px-4 py-3 text-foreground outline-none transition-colors font-body resize-none"
                                />
                            </div>
