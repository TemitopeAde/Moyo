...
export default function Footer() {
    ...
    return (
        <footer className="py-24 bg-background border-t border-foreground/5 font-body">
            <div className="container mx-auto px-6 md:px-12">
                <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-24">
                    <div className="space-y-6">
                        <h3 className="text-2xl font-heading text-foreground tracking-tight">MOYO<span className="text-gold">.</span></h3>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-24">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <a href="#" className="text-foreground/60 hover:text-gold transition-colors"><FaInstagram size={18} /></a>
                                <a href="#" className="text-foreground/60 hover:text-gold transition-colors"><FaBehance size={18} /></a>
                                <a href="#" className="text-foreground/60 hover:text-gold transition-colors"><FaVimeoV size={18} /></a>
                            </div>
                        </div>
                ...
                <div className="pt-12 border-t border-foreground/5 flex flex-col md:flex-row justify-between items-center gap-8">
                    <p className="text-[9px] tracking-[0.4em] uppercase text-foreground/20">
                        © 2026 IJABIKEN MOYO. {t('footer.rights')}
                    </p>
                    <div className="flex gap-8 text-[9px] tracking-[0.4em] uppercase text-foreground/20">
