    ...
    return (
        <main className="bg-background min-h-screen">
            ...
            <div className="pt-36 md:pt-52 container mx-auto px-6 md:px-12 pb-32">
                ...
                >
                    <span className="text-accent text-[10px] tracking-[0.5em] uppercase">Venerations</span>
                ...
                <div className="mt-40 border-t border-white/5 pt-32 grid md:grid-cols-2 gap-24 items-center">
                    <div className="space-y-8">
                        <span className="text-accent text-[10px] tracking-[0.5em] uppercase">Publications</span>
